...
static void	detroy_img(t_game *game)
{
	...
	mlx_destroy_image(game->mlxptr, game->player_sho_l);
	mlx_destroy_image(game->mlxptr, game->player_sho_r);
	mlx_destroy_image(game->mlxptr, game->player_sho_u);
	mlx_destroy_image(game->mlxptr, game->player_sho_d);
	if (game->enemi_one)
		mlx_destroy_image(game->mlxptr, game->enemi_one->enemi);
	if (game->enemi_two)
		mlx_destroy_image(game->mlxptr, game->enemi_two->enemi);
	if (game->enemi_tree)
		mlx_destroy_image(game->mlxptr, game->enemi_tree->enemi);
}
